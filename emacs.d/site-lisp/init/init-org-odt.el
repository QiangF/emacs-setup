...
(setup ox-odt
  (:autoload org-odt-export-to-odt)
  (:require ox)
  (:option org-odt-display-outline-level 1 ; level included in caption numbering
           ...
           org-export-odt-convert-processes "soffice --headless --convert-to %f%x --outdir %d %i"
           ...
           (append org-export-filter-item-functions) 'hjh-odt-filter-list-graph-style
           (append org-odt-experimental-features) 'transclude-sole-footnote-references-in-a-table)
  ...
  (setq org-odt-caption-and-numbering-settings
        '((:TABLE:        :variable "Table"        :entity-name "Table"    :caption-style "Table"     :use-outline-levelp nil   :seq-num-format "1")
          (:FIGURE:       :variable "Figure"       :entity-name "Figure"   :caption-style "Figure"    :use-outline-levelp nil   :seq-num-format "1")
          (:SUBENTITY:    :variable "SubEntity"    :entity-name ""         :caption-style "Figure"    :use-outline-levelp nil :seq-num-format "a")
          (:MATH-FORMULA: :variable "Text"         :entity-name "Equation" :caption-style "Figure"    :use-outline-levelp nil   :seq-num-format "1")
