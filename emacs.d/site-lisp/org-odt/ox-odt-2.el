    ...
    (cond
     ...
     (t
      (let* ((equation (org-odt--render-image/formula app
	     ...
	     (contents (concat "<text:tab/>" equation "<text:tab/>" label)))
	;; Decorate contents with the paragraph style it needs to be
	;; enclosed in.  The value of `:p-style' is probed in
	;; `org-odt-paragraph'.
	(propertize contents :p-style
...
(defun org-odt--render-image/formula-for-gdocs (cfg-key href widths heights &optional
  ...
  (let* ((frame-cfg-alist
	  ...
	  ;; both an INNER and an OUTER-FRAME.
	  '(("As-CharImage" ("OrgInlineImage" nil "as-char"))
        ;; non-captioned image: as-char
	    ("ParagraphImage" ("OrgDisplayImage" nil "as-char"))
	    ("PageImage" ("OrgPageImage" nil "page"))
	    ("CaptionedAs-CharImage"
	     ("OrgDisplayImage"
	      " style:rel-width=\"100%\" style:rel-height=\"scale\"" "paragraph")
	    ...
	    ("CaptionedParagraphImage"
	     ("OrgDisplayImage"
	      " style:rel-width=\"100%\" style:rel-height=\"scale\"" "paragraph")
         ;; correction for multi column section: as-char
	     ("OrgImageCaptionFrame" nil "as-char"))
	    ("CaptionedPageImage"
	     ("OrgDisplayImage"
	      " style:rel-width=\"100%\" style:rel-height=\"scale\"" "paragraph")
	     ("OrgPageImageCaptionFrame" nil "page"))
